...
\cftsetindents{subsection}{1.5em}{2.2em}
...
{%
    ...
    \@appendix*{\MakeUppercase{Приложение \asbuk{appendix}} \\ (#1) \\ #2}
    \markboth{\MakeUppercase{#1}}{}
    \addcontentsline{toc}{section}{Приложение \MakeUppercase{\asbuk{appendix}} (#1) #2}
}
\makeatother
